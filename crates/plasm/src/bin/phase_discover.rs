...
// The event-loop `match` arms wrap their bodies in `if !args.quiet { ... }`
// for legibility. Collapsing each into a match guard would scatter the
// quiet-gating logic across pattern positions and hurt readability of an
